...
query <- dbSendQuery(
  ...
  FROM CbreSilver.pjm_dim_contact"
)
...
query <- dbSendQuery(
  ...
  "SELECT project_role_skey, project_role
   FROM CbreSilver.pjm_dim_project_role"
)
...
query <- dbSendQuery(
  ...
  FROM CbreSilver.pjm_fact_project_role"
)
...
query <- dbSendQuery(
  con,
  "SELECT project_skey, project_status, project_phase FROM CbreSilver.pjm_fact_project"
)
...
query <- dbSendQuery(
  con,
  "SELECT project_skey, project_number, project_name FROM CbreSilver.pjm_dim_project"
)
...
query <- dbSendQuery(
  ...
  FROM CbreSilver.pjm_dim_project_activity"
)
...
query <- dbSendQuery(
  ...
  FROM CbreSilver.pjm_fact_project_activity"
)
